[![build](https://github.com/opspec-pkgs/opencontainers.image.build/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/opencontainers.image.build/actions/workflows/build.yml)
